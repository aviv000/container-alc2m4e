...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-alc2m4e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-alc2m4e.containers.anotherwebservice.com/
...
```
git clone git@github.com:aviv000/container-alc2m4e.git
cd container-alc2m4e
```
...
```
docker attach container-alc2m4e
```
